if (window.blocklyObj) {
    ...
    var imagePath = '../../../courses/'+window.SERIAL_NAME+'/course_12/'+window.LANGUAGE_CODE;
    var bgPath = '../../../courses/'+window.SERIAL_NAME+'/course_12/common';
} else {
    var commonPath = './../engine/courses/'+window.SERIAL_NAME+'/common';
    var imagePath = './../engine/courses/'+window.SERIAL_NAME+'/course_12/'+window.LANGUAGE_CODE;
    var bgPath = './../engine/courses/'+window.SERIAL_NAME+'/course_12/common';
}
var courseData = {
    courseId : 12,
    courseName : '课程12',
                            ...
                            {key:'img',value:[
                                            {
                                                ...
                                                style:{textAlign:'center',margin:'2%',flexBasis:'60%'}
                                            }
                                          ]
                            }
                        ],
