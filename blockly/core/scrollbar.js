...
Blockly.Scrollbar = function(workspace, horizontal, opt_pair) {
  ...
  if (horizontal) {
    ...
    this.svgHandle_.setAttribute('height',
      ...
      this.svgBackground_.setAttribute('height',2);
      this.svgHandle_.setAttribute('height',2);
    ...
    this.svgHandle_.setAttribute('width',
        Blockly.Scrollbar.scrollbarThickness - 5);*/
      this.svgBackground_.setAttribute('width', 2);
      this.svgHandle_.setAttribute('width',2);
