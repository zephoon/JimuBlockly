 ...
 */
Blockly.DropDownDiv.showPositionedByBlock = function(owner, block,filedPosition,
  ...
  return Blockly.DropDownDiv.show(this, primaryX, primaryY, secondaryX, secondaryY, opt_onHide,filedPosition);
};
 ...
 */
Blockly.DropDownDiv.show = function(owner, primaryX, primaryY, secondaryX, secondaryY,opt_onHide,filedObj) {
  ...
  // First apply initial translation.
    ...
    if(filedObj!=undefined){
        var leftPosition =   filedObj.position.x-filedObj.size.width;
        if(filedObj.type == "math"){
            leftPosition = primaryX-100;
        }else{
            if(filedObj.size.width<50){
                leftPosition = filedObj.position.x-filedObj.size.width*2;
            }else if(filedObj.size.width>=50 && filedObj.size.width<=80){
                leftPosition =   filedObj.position.x-filedObj.size.width;
            }else if(filedObj.size.width>80){
                leftPosition = filedObj.position.x-filedObj.size.width/2;
            }
        }

        div.style.left = leftPosition + 'px';
        div.style.top = (filedObj.position.y+filedObj.size.height/2) + 'px';
    }else{
