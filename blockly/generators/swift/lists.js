...
/**
 * @fileoverview Generating Swift for list blocks.
 * @author fraser@google.com (Neil Fraser)
 */
'use strict';

goog.provide('Blockly.Swift.lists');

goog.require('Blockly.Swift');


Blockly.Swift['lists_create_empty'] = function(block) {
  // Create an empty list.
  return ['[]', Blockly.Swift.ORDER_ATOMIC];
};

Blockly.Swift['lists_create_with'] = function(block) {
...
Blockly.Swift['lists_repeat'] = function(block) {
  ...
  var functionName = Blockly.Swift.provideFunction_(
      ...
      [ 'function ' + Blockly.Swift.FUNCTION_NAME_PLACEHOLDER_ +
        ...
        '  return array;',
        '}']);
  var argument0 = Blockly.Swift.valueToCode(block, 'ITEM',
      Blockly.Swift.ORDER_COMMA) || 'null';
  var argument1 = Blockly.Swift.valueToCode(block, 'NUM',
      Blockly.Swift.ORDER_COMMA) || '0';
  var code = functionName + '(' + argument0 + ', ' + argument1 + ')';
  return [code, Blockly.Swift.ORDER_FUNCTION_CALL];
};

Blockly.Swift['lists_length'] = function(block) {
...
Blockly.Swift['lists_isEmpty'] = function(block) {
...
Blockly.Swift['lists_indexOf'] = function(block) {
...
Blockly.Swift['lists_getIndex'] = function(block) {
  ...
  var list = Blockly.Swift.valueToCode(block, 'VALUE',
      Blockly.Swift.ORDER_MEMBER) || '[]';
...
Blockly.Swift['lists_setIndex'] = function(block) {
  // Set element at index.
  // Note: Until February 2013 this block did not have MODE or WHERE inputs.
  var list = Blockly.Swift.valueToCode(block, 'LIST',
      Blockly.Swift.ORDER_MEMBER) || '[]';
  var mode = block.getFieldValue('MODE') || 'GET';
  var where = block.getFieldValue('WHERE') || 'FROM_START';
  var at = Blockly.Swift.valueToCode(block, 'AT',
      Blockly.Swift.ORDER_NONE) || '1';
  var value = Blockly.Swift.valueToCode(block, 'TO',
...
Blockly.Swift['lists_getSublist'] = function(block) {
  // Get sublist.
  var list = Blockly.Swift.valueToCode(block, 'LIST',
      Blockly.Swift.ORDER_MEMBER) || '[]';
...
Blockly.Swift['lists_sort'] = function(block) {
  // Block for sorting a list.
  var listCode = Blockly.Swift.valueToCode(
      block, 'LIST',
      Blockly.Swift.ORDER_FUNCTION_CALL) || '[]';
  var direction = block.getFieldValue('DIRECTION') === '1' ? 1 : -1;
  var type = block.getFieldValue('TYPE');
  var getCompareFunctionName = Blockly.Swift.provideFunction_(
          'listsGetSortCompare',
  ['function ' + Blockly.Swift.FUNCTION_NAME_PLACEHOLDER_ +
    '(type, direction) {',
      '  var compareFuncs = {',
...
Blockly.Swift['lists_split'] = function(block) {
  // Block for splitting text into a list, or joining a list into text.
  var value_input = Blockly.Swift.valueToCode(block, 'INPUT',
      Blockly.Swift.ORDER_MEMBER);
  var value_delim = Blockly.Swift.valueToCode(block, 'DELIM',
      Blockly.Swift.ORDER_NONE) || '\'\'';
