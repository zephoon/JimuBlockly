...
/**
  ...
  *
  */
Blockly.JavaScript.blockToCodeInWorkspace = function(block, workspace) {
  ...
  for (i = 0; i < currentTopBlocks.length; i++) {
    ...
    if (topBlock.type === "function_define") {
      functionCode = functionCode + Blockly.JavaScript.blockToCode(topBlock) + "\n";
    }
  }

  var finalCode = functionCode + Blockly.JavaScript.blockToCode(block);
  return finalCode;
};
